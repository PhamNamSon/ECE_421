...
pub fn test_basic_roots() {
    ...
    let b = -2.0;
    let c = -3.0;
    assert_that!(calculator::get_roots(a, b, c), eq((3.0, -1.0)));
}
...
pub fn test_single_root() {
    ...
    let b = -2.0;
    let c = 1.0;
    assert_that!(calculator::get_roots(a, b, c), eq((1.0, 1.0)));
}
...
pub fn test_random_solvable_quadratic() {
    ...
    if discriminant >= 0.0 {
        ...
        assert_that!(calculator::get_roots(a, b, c), eq((root1, root2)));
    }
}
